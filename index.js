...
/////////////////
const BotName = 'Bot-Rasya'; //ini nama bot lo
const instagram = 'https://www.instagram.com/rasya.gaming.5828/';  //ini nama ig lo
const kapanbotaktif = '05:00 - 17:00'; //ini kapan bot lo on
const youtube = 'undefined';//ini channel YouTube lo
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by DikaIsReal')
